...
function pOpenFile(doc, params, isOnlineDoc) {
    ...
    wps.WpsApplication().Activate();
    //以修订模式打开文档
    wps.WpsApplication().ActiveDocument.TrackRevisions=true //开启或者关闭修订
    wps.WpsApplication().ActiveDocument.ShowRevisions=true //显示和隐藏修订记录
    wps.WpsApplication().ActiveWindow.View.ShowRevisionsAndComments=true //显示和隐藏修订记录和批注
    return doc;
}
