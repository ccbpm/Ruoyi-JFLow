...
'@IsCC=1' ||'@NodeIDWork=' || B.NodeIDWork ||A.AtPara as AtPara,
...
AS 
SELECT CONCAT(A.WorkID, CONCAT('-', B.FK_Emp)) AS MyPK, A.WorkID AS WorkID, A.WorkID AS OID, A.Title, A.StarterName,A.RDT, A.NodeName ,A.TodoEmps ,A.SendDT,A.Sender,
