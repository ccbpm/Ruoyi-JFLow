...
DELETE FROM Port_DeptEmp;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('100_yuwen','yuwen','100','集团总部','01','总经理');

-- 市场部 ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1001_zhanghaicheng','zhanghaicheng','1001','集团市场部','02','市场部经理') ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1001_zhangyifan','zhangyifan','1001','集团市场部','07','销售人员岗') ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1001_zhoushengyu','zhoushengyu','1001','集团市场部','07','销售人员岗') ;

-- 研发部 ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1002_qifenglin','qifenglin','1002','集团研发部','03','研发部经理') ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1002_zhoutianjiao','zhoutianjiao','1002','集团研发部','08','程序员岗') ;

-- 服务部经理 ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1003_guoxiangbin','guoxiangbin','1003','客服部经理','04','客服部经理') ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1003_fuhui',            'fuhui','1003','客服部经理','09','技术服务岗') ;

-- 财务部 ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1004_yangyilei','yangyilei','1004','财务部','05','财务部经理') ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1004_guobaogeng','guobaogeng','1004','财务部','10','出纳岗') ;

-- 人力资源部 ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1005_liping','liping','1005','集团总部','06','人力资源部经理') ;
INSERT INTO Port_DeptEmp (MyPK,FK_Emp,FK_Dept,DeptName,StationNo,StationNoT) VALUES('1005_liyan','liyan','1005','集团总部','11','人力资源助理岗') ;
