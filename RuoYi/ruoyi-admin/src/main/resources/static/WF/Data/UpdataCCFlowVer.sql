...
UPDATE Sys_MapAttr SET IsSupperText=2 WHERE (IsSupperText=0 OR IsSupperText IS NULL ) AND MyDataType=7;
...
INSERT INTO Sys_GloVar (No,Name,GroupKey) VALUES ('@WebUser.No','登录人员账号','DefVal');
INSERT INTO Sys_GloVar (No,Name,GroupKey) VALUES ('@WebUser.Name','登录人员名称','DefVal');
INSERT INTO Sys_GloVar (No,Name,GroupKey) VALUES ('@WebUser.FK_Dept','登录人员部门编号','DefVal');
INSERT INTO Sys_GloVar (No,Name,GroupKey) VALUES ('@WebUser.FK_DeptName','登录人员部门名称','DefVal');
INSERT INTO Sys_GloVar (No,Name,GroupKey) VALUES ('@WebUser.FK_DeptFullName','登录人员部门全称','DefVal');
...
-- INSERT INTO Sys_EnCfg(No,GroupTitle) VALUES ('BP.Sys.FrmUI.MapAttrString','@MyPK=基础,基础属性，数据属性.@ColSpan=外观,经典表单属性，外观.');
-- INSERT INTO Sys_EnCfg(No,GroupTitle) VALUES ('TS.Sys.FrmUI.MapAttrString','@MyPK=基础,基础属性，数据属性.@ColSpan=外观,经典表单属性，外观.');

-- 字段属性 Num ;
-- DELETE FROM Sys_EnCfg WHERE No LIKE '%MapAttrNum';
-- INSERT INTO Sys_EnCfg(No,GroupTitle) VALUES ('BP.Sys.FrmUI.MapAttrNum','@MyPK=基础,基础属性，数据属性.@ColSpan=外观,经典表单属性，外观.');
-- INSERT INTO Sys_EnCfg(No,GroupTitle) VALUES ('TS.Sys.FrmUI.MapAttrNum','@MyPK=基础,基础属性，数据属性.@ColSpan=外观,经典表单属性，外观.');


-- 枚举;
-- DELETE FROM Sys_EnCfg WHERE No LIKE '%MapAttrEnum';
-- NSERT INTO Sys_EnCfg(No,GroupTitle) VALUES ('BP.Sys.FrmUI.MapAttrEnum','@MyPK=基础,基础属性，数据属性.@ColSpan=外观,经典表单属性，外观.');
-- INSERT INTO Sys_EnCfg(No,GroupTitle) VALUES ('TS.Sys.FrmUI.MapAttrEnum','@MyPK=基础,基础属性，数据属性.@ColSpan=外观,经典表单属性，外观.');
...
-- 2024.12.27
UPDATE Sys_SFTable SET AtPara=REPLACE(AtPara, '@EnName=TS.FrmUI.SFTableDictNoName','@EnName=TS.FrmUI.SFTableNoName');
UPDATE Sys_SFTable SET AtPara=REPLACE(AtPara, '@EnName=TS.FrmUI.SFTableDictTree','@EnName=TS.FrmUI.SFTableTree');

-- UPDATE WF_Node SET SelfFormEnRoot=0 WHERE SelfFormEnRoot Is NULL OR SelfFormEnRoot=''
