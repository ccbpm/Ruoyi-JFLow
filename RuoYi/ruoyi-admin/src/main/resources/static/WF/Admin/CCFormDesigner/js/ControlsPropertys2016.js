...
CCForm_Control_Enum = {
    ...
    **/
    DefVal: [{ Text: '选择系统约定默认值', Value: '' },
                { Text: '登录人员账号', Value: '@WebUser.No' },
                { Text: '登录人员名称', Value: '@WebUser.Name' },
                { Text: '登录人员部门编号', Value: '@WebUser.FK_Dept' },
                { Text: '登录人员部门名称', Value: '@WebUser.FK_DeptName' },
                { Text: '登录人员部门全称', Value: '@WebUser.FK_DeptFullName' },
