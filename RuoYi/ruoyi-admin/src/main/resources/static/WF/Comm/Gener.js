jQuery.getScript(basePath + "/Portal/Standard/js/crypto-js.min.js");
jQuery.getScript(basePath + "/Portal/Standard/js/aes.js");
/**
 * 异步加载（layui.open）
...
var Entity = (function () {
    ...
    Entity.prototype = {
        ...
        DoMethodReturnString: function (methodName, myparams) {
            ...
            if (params.lastIndexOf("[～]") == params.length - 3)
...
var DBAccess = (function () {
    ...
    DBAccess.RunSQLReturnVal = function (sql, dbSrc) {
        ...
        handler.AddPara("SQL", encrypt(sql));
    ...
    HttpHandler.prototype = {
        ...
        DoMethodReturnString: function (methodName) {
            ...
            if (methodName === 'Login_Submit' || methodName === 'Login_AdminOnlySaas' ||  methodName === 'ChangePassword_Submit') {
                ...
                parameters.append(key, encrypt(encryptStr))
