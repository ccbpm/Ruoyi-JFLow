...
public class WindowTemplate extends EntityNoName
{
	...
	*/
	...
	{
		return this.GetValStrByKey(WindowTemplateAttr.DBSrc);
	}
	public final void setDBSrc(String value)
	{
		this.SetValByKey(WindowTemplateAttr.DBSrc, value);
	}
	...
	*/
	...
	public Map getEnMap() {
		...
		map.AddTBString(WindowTemplateAttr.DBSrc, null, "数据源", true, false, 0, 100, 20);
