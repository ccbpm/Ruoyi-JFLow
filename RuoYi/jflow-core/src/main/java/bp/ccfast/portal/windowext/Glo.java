...
public class Glo
{
	public static Map StationDBSrcMap(String desc)
	{
		...
		map.AddTBStringDoc("C0Ens", null, "列0外键数据(可选)", true, false, true, 10);
		...
		map.AddTBString(WindowTemplateAttr.PageID, null, "PageID", false, false, 0, 100, 20, true);
		map.AddTBString("WinDocModel", null, "WinDocModel", false, false, 0, 100, 20, true);
