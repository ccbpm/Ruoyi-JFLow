...
public class EventListNode
{
	...
	*/
	 ...
	 * 当节点退回到此节点
	 */
	public static final String ReturnThisNode = "ReturnThisNode";
	/**
	 当节点撤销发送前
	*/
	...
	*/
	...
	public static final String NodeHuiQian="NodeHuiQian";

	public static final String RebackOverFlow="RebackOverFlow";
