...
public class MapAttrDT extends EntityMyPK
{
	...
	*/
	...
	public Map getEnMap() {
		...
		map.AddDDLSysEnum(MapAttrAttr.IsSupperText, 2, "格式", true, true, MapAttrAttr.IsSupperText, "@0=YYYY-MM-dd@1=YYYY-MM-dd HH@2=YYYY-MM-dd HH:mm@3=YYYY-MM-dd HH:mm:ss@4=YYYY-MM@5=HH:mm@6=HH:mm:ss@7=MM-dd@8=YYYY@9=MM");
