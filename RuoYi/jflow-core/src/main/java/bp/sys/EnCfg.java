...
public class EnCfg extends EntityNoName
{
	...
	*/
	...
	public Map getEnMap() {
		...
		map.AddDDLSysEnum("PosRefFuncMobile", 0, "(移动端)相关功能显示位置", true, true, "PosRefFuncMobile", "@0=不显示@1=显示底部@2=显示左");
		...
		cfg += "@2=/CCForm/FrmGener.htm 经典表单解析器";
		...
		map.AddTBString(EnCfgAttr.UrlExt, null, "要打开的Url(PC)", true, false, 0, 500, 60, true);
		map.AddTBString(EnCfgAttr.MobileUrlExt, null, "要打开的Url(移动端)", true, false, 0, 500, 60, true);
