 ...
 * Emp 的摘要说明。
 */
public class EmpForJC extends EntityNoName {
...
//ORIGINAL LINE: byte[] data = Convert.FromBase64String(pass);
     ...
     * @param userID 编号
     */
    public EmpForJC(String userID) throws Exception {
...
//        }
        ...
        map.AddDDLEntities(EmpAttr.FK_Dept, null, "部门", new Depts(), false);
        ...
        //平铺模式.
        map.getAttrsOfOneVSM().AddGroupPanelModel(new TeamEmps(), new Teams(), TeamEmpAttr.EmpNo, TeamEmpAttr.TeamNo, "标签", TeamAttr.TeamTypeNo);
    ...
    protected boolean beforeDelete() throws Exception {
        ...
        Glo.WriteUserLog("删除人员:" + this.ToJson(), "组织数据操作");
