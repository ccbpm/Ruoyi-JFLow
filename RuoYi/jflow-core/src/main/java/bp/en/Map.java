...
public class Map  implements Serializable
{
	...
	private DBType _HisDBType = SystemConfig.getAppCenterDBType();
	public final DBType getHisDBType(){
		return _HisDBType;
	}

	public final void setHisDBType(DBType value){
		_HisDBType = value;
	}
	private String _AppCenterDBVarStr = SystemConfig.getAppCenterDBVarStr();
	public final String getAppCenterDBVarStr(){
		return _AppCenterDBVarStr;
	}

	public final void setAppCenterDBVarStr(String value){
		_AppCenterDBVarStr = value;
	}
	///chuli
	/**
	...
	public final Attr GetAttrByDesc(String desc)  {
		for (Attr attr : this.getAttrs())
		{
			if (attr.getDesc().equals(desc) || attr.getKey().equals(desc)== true)
			{
				return attr;
			}
		}
	...
	public final void setDtls(EnDtls value){
		_Dtls = value;
	}
	/**
	 所有的明细
	...
	{
		String str = value;
		if (str.contains("{LSH4}"))
			str = "4";
		if (str.contains("{LSH3}"))
			str = "3";
		if (str.contains("{LSH2}"))
			str = "2";
	...
	{
		if(DataType.IsNullOrEmpty(this.getPhysicsTable()))
			return this.getPhysicsTable();
   ...
   //#endregion 方法分组.
	...
	public void AddLang()  {
		...
		this.AddTBString("NameJA", null, "日文", true, false, 0, 200, 150, false);
		this.AddTBString("NameVI", null, "越南", true, false, 0, 200, 150, false);
	}
