...
public class User extends EntityNoName
{
	...
	public final String getToken()  {
		return this.GetValStrByKey(UserAttr.Token);
	}
	public final void setToken(String value){
		this.SetValByKey(UserAttr.Token, value);
	}
	/** 
	 拼音
	*/
	...
	*/
	...
	public Map getEnMap() {
	  ...
	  // map.setEnType(EnType.App);
		...
		map.AddTBString(UserAttr.Token, null, "Token", false, false, 0, 512, 36);
		...
		map.AddTBString(UserAttr.RefreshToken, null, "公众号的RefreshToken(用于过期时刷新微信服务号的access_token)", true, false, 0, 512, 132, true);
