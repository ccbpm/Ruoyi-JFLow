...
public class Conds extends Entities
{
	...
	*/
	...
	/**
	 ...
	 @return
	*/
	public final boolean GenerResult(GERpt en, WebUserCopy webUser,Node nd)
	{
		...
		{
			throw new RuntimeException("err@计算条件出现错误:" + this.NodeID + " - " + Log.getStackTraceInfo(ex));
		} catch (Exception e) {
