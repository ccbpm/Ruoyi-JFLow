...
public class BtnAttr
{
	...
	*/
	 ...
	 * 公文版本
	 */
	public static final String OfficeTrackLab = "OfficeTrackLab";
	/**
	 * 下载公文正文标签
	 */
	public static final String DownGovLab = "DownGovLab";
	/**
	 * kk公文在线预览标签
	 */
	public static final String KKViewLab = "KKViewLab";
	/**
	 * vsto插件下载标签
	 */
	public static final String DownVSTOLab = "DownVSTOLab";
	/**
	 * 是否启用公文版本
	 */
	public static final String OfficeTrackEnalbe = "OfficeTrackEnalbe";
	/**
	 * 是否启用下载公文正文
	 */
	public static final String DownGovEnable = "DownGovEnable";
	/**
	 * 是否启用kk公文在线预览
	 */
	public static final String KKViewEnable = "KKViewEnable";
	/**
	 * vsto插件下载是否启用
	 */
	public static final String DownVSTOEnable = "DownVSTOEnable";
	...
	*/
	...
	public static final String PrintPDFAndBBSEnable = "PrintPDFAndBBSEnable";


	/**
	 * 预置处理人
	 */
	public static final String PreplaceWokerLab = "PreplaceWokerLab";
	public static final String PreplaceWokerEnable = "PreplaceWokerEnable";


	public static final String TZWorkerEnable = "TZWorkerEnable";
