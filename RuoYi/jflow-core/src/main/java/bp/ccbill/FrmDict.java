...
public class FrmDict extends EntityNoName
{
	...
	*/
	...
	public Map getEnMap() {
		...
		map.AddDDLSysEnum(FrmDictAttr.EntityType, 0, "业务类型", true, false, FrmDictAttr.EntityType, "@0=独立表单@1=单据@2=Dict实体@3=Tree实体@5=EntityNoName实体@100=数据源实体");
		map.SetHelperAlert(FrmDictAttr.EntityType, "该实体的类型,@0=独立表单@1=单据@2=Dict实体@3=Tree实体@5=EntityNoName实体@100=数据源实体.");
		...
		map.AddTBInt(FrmBillAttr.TableStyle, 0, "表格内容展示类型", false, false);
			///#endregion 实体表单.
...
//			collection.SetPara("EnName","TS.CCBill.CollectionDelete");
	...
	/**
	 检查enittyNoName类型的实体
	*/
	public final void CheckEnityTypeAttrsFor_Dict() throws Exception {
		//取出来全部的属性.
